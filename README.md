...
Quando tiveres o link público da app, podes usar o ficheiro `embed-widget.html` para criar um botão circular flutuante no site.

Se quiseres colocar o chatbot diretamente na página, usa este bloco HTML:
